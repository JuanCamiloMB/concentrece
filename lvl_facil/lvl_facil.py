...
#except FileNotFoundError:
    #print('Ejecute el nivel facil manualmente por error desconocido')
...
while True:
    ...
    if juego_iniciado:
        ...
        pantalla_juego.blit(fuente.render(texto_puntaje, True, color_negro), (len(cuadros)*medida_cuadro, 0))
    else:
