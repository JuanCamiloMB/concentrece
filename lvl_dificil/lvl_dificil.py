...
cuadros = [
    ...
    [Cuadro("assets/microsoft.png"), Cuadro("assets/microsoft.png"),
     Cuadro("assets/internet.png"), Cuadro("assets/internet.png"),
     Cuadro("assets/spotify.png"), Cuadro("assets/spotify.png")],
]
...
anchura_pantalla = len(cuadros[0]) * medida_cuadro + 100
...
while True:
    ...
    if juego_iniciado:
        ...
        pantalla_juego.blit(fuente.render(texto_puntaje, True, color_negro), (len(cuadros[0]) * medida_cuadro, 0))
    else:
